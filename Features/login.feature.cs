...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("locked_out_user", "secret_sauce", "error", null)]
        [NUnit.Framework.TestCaseAttribute("wrong_user", "wrong_pass", "error", null)]
        public void LoginWithMultipleUsers(string username, string password, string result, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login with multiple users", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 4
